...
async fn map_operations() {
    ...
    let i2 = Value::from(7);
    let op = [
        map::decrement_value(mpolicy, bin_name, &k, &i1),
        map::increment_value(mpolicy, bin_name, &k, &i2),
    ];
    let rec = client.operate(&wpolicy, &key, &op).await.unwrap();
    ...
    let op = [map::get_by_index_range_from(
        bin_name,
        3,
        map::ReturnType::Value,
    )];
    ...
    let op = [map::get_by_value_range(
        bin_name,
        &beg,
        &end,
        map::ReturnType::Count,
    )];
    let rec = client.operate(&wpolicy, &key, &op).await.unwrap();
    ...
    let op = [map::get_by_rank_range_from(
        bin_name,
        2,
        map::ReturnType::Count,
    )];
    ...
    let op = [map::remove_by_key_range(
        bin_name,
        &mkey,
        &mkey2,
        map::ReturnType::Count,
    ...
    let op = [map::remove_by_value_list(
        bin_name,
        &mkey,
        map::ReturnType::Count,
    )];
    ...
    let op = [map::remove_by_value_range(
        bin_name,
        &mkey,
        &mkey2,
        map::ReturnType::Count,
    ...
    let op = [map::remove_by_index_range(
        bin_name,
        1,
        2,
        map::ReturnType::Value,
    ...
    let op = [map::remove_by_index_range_from(
        bin_name,
        1,
        map::ReturnType::Value,
    )];
    ...
    let op = [map::remove_by_rank_range(
        bin_name,
        1,
        2,
        map::ReturnType::Value,
    ...
    let op = [map::remove_by_rank_range_from(
        bin_name,
        3,
        map::ReturnType::Value,
    )];
    ...
    let mkey = Value::from("b");
    let op = [map::remove_by_key_relative_index_range(
        bin_name,
        &mkey,
        2,
        map::ReturnType::Value,
    ...
    let op = [map::remove_by_value_relative_rank_range(
        bin_name,
        &mkey,
        1,
        map::ReturnType::Value,
    ...
    let mkey = Value::from("a");
    let op = [map::get_by_key_relative_index_range(
        bin_name,
        &mkey,
        1,
        map::ReturnType::Value,
    ...
    let mkey = Value::from("a");
    let op = [map::get_by_key_relative_index_range_count(
        bin_name,
        &mkey,
        1,
        2,
    ...
    let mkey = Value::from(2);
    let op = [map::get_by_value_relative_rank_range(
        bin_name,
        &mkey,
        1,
        map::ReturnType::Value,
    ...
    let mkey = Value::from(2);
    let op = [map::get_by_value_relative_rank_range_count(
        bin_name,
        &mkey,
        1,
        1,
